...
const ProjectDataAnlysics = () => {

  const [showPreviews,setShowPreviews] =useState(false);
  const [currentIndexs,setCurrentIndexs] =useState(0);

  const images =[
    "public/dataimages/dataimg1.jpg",
    "public/dataimages/dataimg2.jpg",
    "public/dataimages/dataimg3.jpg",
    "public/dataimages/dataimg4.jpg",
    "public/dataimages/dataimg5.jpg",
  ];

  const nextImage =() =>{
    setCurrentIndexs((prev)=>(prev+1)%images.length);
  };

  const prevImage =()=>{
    setCurrentIndexs((prev)=>
  ...
  return (
    <div>
      <div className="rounded-xl overflow-hidden card-hover bg-white dark:bg-dark-100 shadow-lg border border-gray-100 dark:border-gray-700">
        <div>
          ...
          <div className="p-3 sm:p-4 lg:p-6">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <a
                  href="https://github.com/Rohitb-kai/DataAnalysics"
                  target="_blank"
                ...
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
                  <div className="bg-white dark:bg-gray-500 p-7 rounded-xl relative max-w-2xl w-full">
                    ...
                    <div className="text-center text-gray-500 mt-5 text-sm">
                      image{currentIndexs + 1} of {images.length}
                    </div>
                  </div>
                </div>
              )}
...
export default ProjectDataAnlysics